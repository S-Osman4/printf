...
| ------------- |:-------------:|
| [main.h](./test/main.h) | Header file, contains the prototypes of the functions used that can be found in the other files. |
| [printf.c](./test/_printf.c)     | Contains the _printf function.|
| [selector.c](./selector.c)    | Contains the function that selects the correct  function requested by the user. |
| [mandatory.c](./mandatory.c)   | Contains the functions that allow printing basic  formats (%c, %s, %d, %i, %%).|
|[ advanced.c](./advanced.c) | Contains advanced printing functions (Unsigned; %u, reverse; %r, rot13; %R, octal; %o, binary; %b).|
|[ _putchar.c](./_putchar.c) | Contains the auxiliary _putchar function, used to print.|
|[man_3_printf](./mans_3_printf)   | Custom manual for our _printf function.|
